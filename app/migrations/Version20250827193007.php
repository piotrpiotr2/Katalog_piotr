 ...
 */
final class Version20250827193007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tasks_tags (album_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_85533A501137ABCF (album_id), INDEX IDX_85533A50BAD26311 (tag_id), PRIMARY KEY(album_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE tasks_tags ADD CONSTRAINT FK_85533A501137ABCF FOREIGN KEY (album_id) REFERENCES albums (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE album_tags (album_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_BB72266BAD26311 (tag_id), INDEX IDX_BB722661137ABCF (album_id), PRIMARY KEY(album_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
